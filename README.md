...
| **Formulas** | 129 functions -- SUM, VLOOKUP, XLOOKUP, INDEX/MATCH, QUERY, IMPORTRANGE, XIRR, LAMBDA, LET, ARRAYFORMULA, and more |
...
macOS App (.dmg, ~18 MB)
  Tauri v2 (WKWebView + Rust backend)
    ...
    Rust backend
      lattice-core       Spreadsheet engine (129 formulas, dependency graph, cell storage)
