...
const SHORTCUT_CATEGORIES: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: 'F4', description: 'Toggle absolute/relative reference ($)' },
      ...
      { keys: 'Cmd+Shift+T', description: 'Paste transposed' },
      ...
      { keys: "Cmd+'", description: 'Copy formula from cell above' },
  ...
  },
  {
    title: 'Borders',
    shortcuts: [
      { keys: 'Option+Shift+1', description: 'Top border' },
      { keys: 'Option+Shift+2', description: 'Right border' },
      { keys: 'Option+Shift+3', description: 'Bottom border' },
      { keys: 'Option+Shift+4', description: 'Left border' },
      { keys: 'Option+Shift+6', description: 'Remove all borders' },
      { keys: 'Option+Shift+7', description: 'Outer border' },
    ],
  },
  {
    title: 'View',
